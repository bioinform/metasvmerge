...
def run_spades_single(intervals=[], bam=None, spades=None, spades_options="", work=None, pad=SPADES_PAD,
...
def run_spades_parallel(bam=None, spades=None, spades_options="", bed=None, work=None, pad=SPADES_PAD, nthreads=1, chrs=[],
    ...
    if nthreads > 1:
        ...
        for i in xrange(nthreads):
            ...
            kwargs_dict = {"intervals": intervals, "bam": bam, "spades": spades, "spades_options": spades_options,
